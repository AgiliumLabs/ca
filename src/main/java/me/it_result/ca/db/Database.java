...
public interface Database {
	...
	public void writeBytes(String alias, String property, byte[] data) throws Exception;
	public void writeString(String alias, String property, String data) throws Exception;
